...
**Rates 'R Us** is a movie review website by Moby Viesca, a self-proclaimed famous movie critic. There are movie posts with general information written by Moby or his employees, and Moby's current top movies have their own little section on the first page, with Moby's motivation. Each movie has its own page with more information and, if applicable, Moby's motivation text. As a user, you can register, and rate and review the movies as well! Your rating counts to the overall average rating. You can see all your reviews on the **My reviews** page.
...
- __Movie_detail__
   ...
   ![Movie information mobile lay-out](docs/features/movie-detail-mobile.png)
    ...
    - __Reviews__
      ...
      - After clicking **Edit**, you move to the review form where the fields are populated with your rating and review, the **Submit** button changes to **Update**.
